...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public static int pineconeCount;
        ...
        void OnFire(InputValue value)
        {
            ...
            test.transform.position = gameObject.transform.position + projectileHeading;
        }
            ...
            if (Input.GetKeyDown(KeyCode.Space))
            {
                ...
                switch (currentElement)
                {
                    ...
                    case ElementState.LIGHT:
                        ...
                        lightProj.transform.position = (gameObject.transform.position +  projectileHeading*0.2f)+ new Vector3(0.0f, 3.0f, 0.0f);
                        pProjectileController lightppc = lightProj.GetComponent<pProjectileController>();
                        lightppc.SetDirection(projectileHeading/3);
                    ...
                    case ElementState.WATER:
                        ...
                        newProj.transform.position = (gameObject.transform.position + projectileHeading * 0.2f) + new Vector3(0.0f, 3.0f, 0.0f);
                        pProjectileController waterppc = newProj.GetComponent<pProjectileController>();
                        waterppc.SetDirection(projectileHeading / 3);
                        shootingCooldownTimer = shootingCooldown;
        ...
        private void CameraRotation()
        {
            ...
            projectileHeading = (target.transform.position - gameObject.transform.position);
            projectileHeading = new Vector3(-projectileHeading.x, 0.0f, -projectileHeading.z);
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                // Jump
                if (_input.jump && _jumpTimeoutDelta <= 0.0f && allowJump)
                {
